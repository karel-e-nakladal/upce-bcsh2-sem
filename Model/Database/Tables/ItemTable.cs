...
namespace WpfApp1.Model.Database.Tables
{
    public class ItemTable
    {
        ...
        public Item Add(Item item)
        {
            ...
            cmd.CommandText = "INSERT INTO items (world_id, name, description, icon, value, page_id) VALUES ($world_id, $name, $description, $icon, $value, $page_id)";
        ...
        public Item Update(Item item)
        {
            ...
            cmd.CommandText = "UPDATE items SET world_id = $world_id, name = $name, description = $description, icon = $icon, value = $value WHERE id = $id";
        ...
        public Item Remove(int id)
        {
            ...
            Manager.GetInstance().ImageManager.DeleteEntity(EntityType.Item, removed.World, id);
